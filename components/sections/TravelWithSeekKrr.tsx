  ...
  },
  {
    ...
    lines: (
      <>
        ...
        Quests
        <br />
        <span className="line-through opacity-70">₹500</span> = 0₹
        <br />
        (Early Bird
        <br />
        Offer)
      ...
      >
        <div className="relative w-[520px] h-[520px] sm:w-[640px] sm:h-[640px] md:w-[760px] md:h-[760px] lg:w-[900px] lg:h-[900px]">
          ...
          <div className="absolute inset-0 flex items-center justify-center z-10 pointer-events-none">
            <h2 className="font-handwriting text-[32px] sm:text-[40px] md:text-[48px] lg:text-[56px] font-bold leading-[1.15] text-center text-black whitespace-pre-line [text-shadow:3px_3px_0_var(--color-orange-accent)]">
              {`Travel\nWith\n${siteConfig.name}`}
            </h2>
          </div>
...
function WingsSvg({ muted = false }: { muted?: boolean }) {
  ...
  return (
    ...
    >
      ...
      {/* Top tail feathers */}
      <path
        d="M97.5259 39.5352C95.9259 40.3352 87.8592 48.2018 84.0259 52.0352H99.0259C99.5259 49.0352 98.5259 42.5352 97.5259 39.5352Z"
        fill={blue}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M51.0259 52.0352L55.0259 4.53516C65.8259 6.53516 71.1925 20.0352 72.5259 26.5352L62.0259 52.0352H51.0259Z"
        fill={blue}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M39.0259 52.0352L31.0259 18.5352C21.4259 10.5352 10.3592 12.8685 6.02588 15.0352L25.5259 52.0352H39.0259Z"
        fill={blue}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M82.5259 52.0352H63.5259C65.5259 45.0352 73.5259 26.0352 79.0259 15.5352C89.0259 24.7352 88.8592 40.3685 87.5259 47.0352L82.5259 52.0352Z"
        fill={orange}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M40.0259 52.0352C37.6259 43.2352 31.5259 18.0352 29.0259 1.03516C45.8259 3.83516 51.6925 15.5352 52.5259 21.0352L50.0259 52.0352H40.0259Z"
        fill={orange}
        stroke={dark}
        strokeWidth="0.5"
      />
      ...
      <path
        d="M97.5259 300.535C92.5259 296.202 82.4259 287.235 82.0259 286.035H98.5259C99.3259 287.235 98.1925 296.202 97.5259 300.535Z"
        fill={blue}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M55.0259 336.035L51.0259 286.035H61.5259C61.6925 286.535 64.1259 292.835 72.5259 314.035C69.7259 329.235 59.6925 335.035 55.0259 336.035Z"
        fill={blue}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M26.5259 286.035H39.5259C39.3592 286.702 37.4259 294.835 31.0259 322.035C21.8259 330.035 10.5259 327.702 6.02588 325.535L26.5259 286.035Z"
        fill={blue}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M79.0259 325.035C77.4259 323.435 67.3592 298.368 62.5259 286.035H80.0259L87.5259 293.535C90.5067 311.917 82.6275 320.92 79.0934 324.958L79.0259 325.035Z"
        fill={orange}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M50.0259 286.035C50.8592 297.035 52.5259 319.235 52.5259 320.035C47.5259 335.035 35.5259 338.535 29.0259 339.535C30.0259 328.535 40.5259 286.535 40.5259 286.035C40.5259 285.635 46.8592 285.868 50.0259 286.035Z"
        fill={orange}
        stroke={dark}
        strokeWidth="0.5"
      />
...
function BodySvg({
  ...
  return (
    ...
    >
      ...
      <path
        d="M26.1553 52.662V285.564H136.928V52.662H26.1553Z"
        fill={bodyColor}
        stroke={dark}
      />
      {/* Head/eye */}
      <path
        d="M26.0259 155.793C10.5824 152.271 9.47913 185.995 26.0259 184.486V155.793Z"
        fill={dark}
        stroke={dark}
        strokeWidth="0.5"
      />
      <path
        d="M25.5259 162.535H17.5259C15.5259 166.535 15.5259 173.035 17.5259 178.035H25.5259V162.535Z"
        fill={blue}
        stroke={blue}
        strokeWidth="0.5"
      />
      {/* Beak */}
      <path
        d="M14.5259 177.035L2.02588 170.535L14.5259 163.035C13.3259 167.035 14.0259 174.035 14.5259 177.035Z"
        fill={muted ? bg : "var(--color-orange-accent)"}
        stroke={dark}
        strokeWidth="0.5"
      />
    </svg>
