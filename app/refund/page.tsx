      ...
      <div className="max-w-4xl mx-auto">
        <AnimatedSection className="text-center mb-12">
          ...
          <p className="mt-4 text-lg text-muted-foreground">
            Last updated: {siteConfig.refundLastUpdated}
          </p>
        </AnimatedSection>
        ...
        <AnimatedSection
          amount={0}
          delay={0.1}
          className="bg-card shadow-sm border rounded-3xl overflow-hidden"
        >
          <div className="p-8 sm:p-12 space-y-10 text-card-foreground leading-relaxed">
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                Cancellation requests or complaints can be registered by sending
                an email to{" "}
                <a
                  href="mailto:support@seekkrr.com"
            ...
            <section className="space-y-4">
              ...
              <p className="text-muted-foreground">
                In case of any refunds approved by {siteConfig.name}, it will
                take 7 days for the refund to be processed to your account.
              </p>
            </section>
          </div>
        </AnimatedSection>
