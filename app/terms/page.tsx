...
export const metadata: Metadata = {
    ...
    description: `Terms of Service for ${siteConfig.name}. Rules and guidelines for using our platform.`,
};

export default async function TermsOfServicePage() {
    const res = await fetch("https://cdn.jsdelivr.net/gh/seekkrr/policies@main/en/terms-and-conditions.md", { next: { revalidate: 3600 } });
