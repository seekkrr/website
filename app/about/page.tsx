...
const SketchUnderline = ({ className }: { className?: string }) => (
  ...
  >
    <path
      d="M2.5 7.5C50.5 4.5 150.5 1.5 301.5 5.5"
      stroke="black"
      strokeWidth="4"
      strokeLinecap="round"
    />
    ...
    <div className="min-h-screen bg-theme-beige font-jakarta pt-32 pb-6 px-6 overflow-hidden">
      ...
      <AnimatedSection className="max-w-6xl mx-auto">
        ...
        <div className="border-[2px] border-black rounded-xl w-full max-w-[860px] mx-auto py-12 px-6 md:px-12 text-center bg-white shadow-sm mb-12">
          <h2 className="text-xl md:text-2xl font-bold mb-6 text-black tracking-wide">
            Who are we?
          </h2>
          <p
        ...
        {/* Dear Reader Letter */}
        <AnimatedSection
          className="-mt-10 mb-10 max-w-4xl mx-auto flex justify-center"
          delay={0.4}
        >
